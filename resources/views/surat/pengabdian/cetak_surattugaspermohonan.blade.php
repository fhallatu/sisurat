    ...
    <div class="form-group">
        ...
        <table border="0" align="center">
            ...
            <tr>
                <td align="justify">
                    <justify>
                        <font size="3" style="color: rgb(0, 0, 0)" face="Times New Roman">Berdasarkan surat permohonan
                            dari {{ $srtpengabdian->lok_keg_pengabdian }} Nomor {{ $srtpengabdian->no_srt_permohonan }}.
                            Ketua Lembaga Pengabdian dan Pengabdian Kepada Masyarakat Universitas Bengkulu, menugaskan
                            kepada :
                        </font><br>
                    </justify>
                </td>
        ...
        <table border="0" align="center" width="100%">
            ...
            <tr>
                <td align="justify">
                    <justify>
                        <font size="3" style="color: rgb(0, 0, 0)" face="Times New Roman">Untuk melaksanakan pengabdian
                            kepada masyarakat menjadi narasumber pada tanggal {{ $tgl_kegpengabdian}} -
                            {{ $tgl_slskeg	}} dengan materi "
                            {{ $srtpengabdian->pengabdian->judul_pengabdian }} ".
                            Kegiatan ini mewajibkan adanya luaran seperti yang tercantum pada Pedoman Kegiatan
                            Pengabdian Kepada Masyarakat {{ $srtpengabdian->pengabdian->skema_pengabdian }} Universitas
                            Bengkulu.
                    </justify>
                </td>
            </tr>
