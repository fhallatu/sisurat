...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1> Detail Data Surat Pengabdian </h1>
        </div>
        <div>
            @if ($errors->any())
                ...
                <div class="card">
                    ...
                    <div class="card-body" hidden>
                        <div class="form-group mb-auto">
                            <label for="$id_pengabdian">Judul Pengabdian</label>
                            <input type="text" class="form-control" name="id_pengabdian" placeholder=""
                                value="{{ $srtpengabdian->pengabdian->id_pengabdian }}" disabled />
                        </div>
                    </div>

                    <x-input field="judul_pengabdian" setting="form-control" label="Judul Pengabdian" type="text" ph=""
                        isi="{{ $srtpengabdian->pengabdian->judul_pengabdian }}" disabled />

                    <x-input field="skema_pengabdian" setting="form-control" label="Skema Pengabdian" type="text" ph=""
                        isi="{{ $srtpengabdian->pengabdian->skema_pengabdian }}" disabled />

                    <div class="card-header">
                        <h4>Ketua</h4>
                    </div>
                    <x-input field="nama_user" setting="form-control" label="Nama Ketua" type="text" ph=""
                        isi="{{ $srtpengabdian->pengabdian->user->nama_user }}" disabled />

                    <x-input field="nip_user" setting="form-control" label="NIP" type="text" ph=""
                        isi="{{ $srtpengabdian->pengabdian->user->nip_user }}" disabled />

                    <x-input field="nidn_user" setting="form-control" label="NIDN" type="text" ph=""
                        isi="{{ $srtpengabdian->pengabdian->user->nidn_user }}" disabled />

                    <x-input field="fakultas_user" setting="form-control" label="Fakultas" type="text" ph=""
                        isi="{{ $srtpengabdian->pengabdian->user->fakultas_user }}" disabled />

                    <x-input field="prodi_user" setting="form-control" label="Prodi" type="text" ph=""
                        isi="{{ $srtpengabdian->pengabdian->user->prodi_user }}" disabled />
                    ...
                    <div class="card-body">
                        <div class="form-group mb-auto">
                            ...
                            <input type="text" class="form-control" name="jenis_suratpengabdian" placeholder=""
                                value="{{ $srtpengabdian->jenis_suratpengabdian }}" disabled />
                        </div>
                    </div>
                    ...
                    @if( $srtpengabdian->jenis_suratpengabdian == 'surat tugas')
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$jenis_surattugas">Jenis Surat Tugas</label>
                                <input type="text" class="form-control" name="jenis_surattugas" placeholder=""
                                    value="{{ $srtpengabdian->jenis_surattugas }}" disabled />
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="date" class="form-control" name="tgl_srt_permohonan"
                                    ...
                                    value="{{ $srtpengabdian->tgl_srt_permohonan }}" disabled />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="text" class="form-control" name="no_srt_permohonan"
                                    ...
                                    value="{{ $srtpengabdian->no_srt_permohonan }}" disabled />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$file_srt_mitra">File Surat Permohonan Mitra</label><br>
                                <a href="{{ asset('file_srt_mitra/'. $srtpengabdian->file_srt_mitra) }}"
                                    download='{{ $srtpengabdian->file_srt_mitra }}' class="download"
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="Unduh">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="date" class="form-control" name="tgl_keg_pengabdian"
                                    ...
                                    value="{{ $srtpengabdian->tgl_keg_pengabdian }}" disabled />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$tgl_sls_keg">Tanggal Selesai Kegiatan Pengabdian</label>
                                <input type="date" class="form-control" name="tgl_sls_keg"
                                    placeholder="Tuliskan Tanggal Selesai Kegiatan Pengabdian..."
                                    value="{{ $srtpengabdian->tgl_sls_keg }}" disabled />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="text" class="form-control" name="lok_keg_pengabdian"
                                    ...
                                    value="{{ $srtpengabdian->lok_keg_pengabdian }}" disabled />
                            </div>
                        </div>
                    </div>
                    @else
                    ...
                    <div class="card-body">
                        <div class="form-group mb-auto">
                            ...
                            <a href="{{ asset('file_proposal/'. $srtpengabdian->file_proposal) }}"
                                download='{{ $srtpengabdian->file_proposal }}' class="download" data-toggle="tooltip"
                    ...
                    <div>
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="text" class="form-control" name="no_srt_mitra"
                                    placeholder="Tuliskan Nomor Surat Keterangan dari Mitra..."
                                    value="{{ $srtpengabdian->no_srt_mitra }}" />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="date" class="form-control" name="tgl_srt_mitra"
                                    placeholder="Tuliskan Tanggal Surat Keterangan dari Mitra..."
                                    value="{{ $srtpengabdian->tgl_srt_mitra }}" />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$file_srt_mitra">File Surat Mitra</label><br>
                                <a href="{{ asset('file_srt_mitra/'. $srtpengabdian->file_srt_mitra) }}"
                                    download='{{ $srtpengabdian->file_srt_mitra }}' class="download"
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="Unduh">
                                    <svg id="Capa_1" enable-background="new 0 0 512 512" height="25"
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$file_laporan">File Cover dan Halaman Pengesahan</label><br>
                                <a href="{{ asset('file_laporan/'. $srtpengabdian->file_laporan) }}"
                                    download='{{ $srtpengabdian->file_laporan }}' class="download" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Unduh">
                                    <svg id="Capa_1" enable-background="new 0 0 512 512" height="25"
                                        viewBox="0 0 512 512" width="25" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$file_absensi">File Absensi</label><br>
                                <a href="{{ asset('file_absensi/'. $srtpengabdian->file_absensi) }}"
                                    download='{{ $srtpengabdian->file_absensi }}' class="download" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Unduh">
                                    <svg id="Capa_1" enable-background="new 0 0 512 512" height="25"
                                        viewBox="0 0 512 512" width="25" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$foto_kegiatan">File Foto Kegiatan</label><br>
                                <a href="{{ asset('foto_kegiatan/'. $srtpengabdian->foto_kegiatan) }}"
                                    download='{{ $srtpengabdian->foto_kegiatan }}' class="download"
                                    data-toggle="tooltip" data-placement="top" title="" data-original-title="Unduh">
                                    <svg id="Capa_1" enable-background="new 0 0 512 512" height="25"
                                        viewBox="0 0 512 512" width="25" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$luaran_keg">Luaran Kegiatan</label>
                                <input type="text" class="form-control" name="luaran_keg" placeholder=""
                                    value="{{ $srtpengabdian->luaran_keg }}" disabled />
                            </div>
                        </div>
                    </div>
                    @else
                        ...
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="text" class="form-control" name="judul_jurnal"
                                    placeholder="Tuliskan Judul Jurnal / Artikel..."
                                    value="{{ $srtpengabdian->judul_jurnal }}" disabled />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="text" class="form-control" name="pub_jurnal"
                                    placeholder="Tuliskan Tempat Publikasi dan Volume ( Nomor ) Jurnal..."
                                    value="{{ $srtpengabdian->pub_jurnal }}" disabled />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="text" class="form-control" name="link_kegiatan"
                                    placeholder="Tuliskan Link Jurnal / Artikel..."
                                    value="{{ $srtpengabdian->link_kegiatan }}" disabled />
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                <label for="$file_jurnal">File Jurnal</label><br>
                                <a href="{{ asset('file_jurnal/'. $srtpengabdian->file_jurnal) }}"
                                    download='{{ $srtpengabdian->file_jurnal }}' class="download" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Unduh">
                                    <svg id="Capa_1" enable-background="new 0 0 512 512" height="25"
                                        viewBox="0 0 512 512" width="25" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-auto">
                            <label for="$file_booklet">File Booklet</label><br>
                            <a href="{{ asset('file_booklet/'. $srtpengabdian->file_booklet) }}"
                                download='{{ $srtpengabdian->file_booklet }}' class="download" data-toggle="tooltip"
                                data-placement="top" title="" data-original-title="Unduh">
                                <svg id="Capa_1" enable-background="new 0 0 512 512" height="25" viewBox="0 0 512 512"
                                    width="25" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                    ...
                    <div>
                        <div class="card-body">
                            <div class="form-group mb-auto">
                                ...
                                <input type="text" class="form-control" name="link_kegiatan"
                                    placeholder="Tuliskan Link Youtube..." value="{{ $srtpengabdian->link_kegiatan }}"
                                    disabled />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-auto">
                            <label for="$file_booklet">File Surat Pengabdian</label><br>
                            <a href="{{ asset('file_suratpengabdian/'. $srtpengabdian->file_suratpengabdian) }}"
                                download='{{ $srtpengabdian->file_suratpengabdian }}' class="download"
                                data-toggle="tooltip" data-placement="top" title="" data-original-title="Unduh">
                                <svg id="Capa_1" enable-background="new 0 0 512 512" height="25" viewBox="0 0 512 512"
                                    width="25" xmlns="http://www.w3.org/2000/svg">
                                    <g>
